...
require('lazy').setup({
  ...
  {
    -- Useful plugin to move around a file
    'phaazon/hop.nvim',
    config = function()
      require('hop').setup {
  ...
  -- Testing system
  -- So that I can quickly run tests
  {
  ...
  { -- To show all problems in project!
    'folke/trouble.nvim',
        ...
        config = {
          ...
          center = {
            ...
            },
            {
              icon = '  ',
              desc = 'Find File                               ',
              action = 'Neotree filesystem',
              key = 'f',
            },
          },
        },
      }
      vim.api.nvim_set_hl(0, 'DashboardHeader', { fg = '#F4B185', ctermfg = 2 })
    end,
  },
  ...
  -- Indent Blank Line
  -- Show lines for the entire code block in the left
  {
    ...
    opts = {
      ...
      scope = {
        ...
        show_start = true, -- line at context start
        show_end = false,
      },
      exclude = {
        filetypes = {
  ...
  -- go.nvim; a plugin for go language development
  {
    'ray-x/go.nvim',
...
vim.api.nvim_create_user_command('ColorLotus', function()
  vim.cmd.colorscheme 'kanagawa-lotus'
end, {
  desc = 'sets colorscheme to kanagawa lotus variant',
})

vim.api.nvim_create_user_command('ColorDragon', function()
  vim.cmd.colorscheme 'kanagawa-dragon'
end, {
  desc = 'sets colorscheme to kanagawa dragon variant',
})

vim.api.nvim_create_user_command('ColorWave', function()
